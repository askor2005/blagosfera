...
<div class="modal fade" id="community-to-community-accounts-move-modal" tabindex="-1" role="dialog" aria-hidden="true"
     data-keyboard="false">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <select id="to-community-id" class="form-control"></select>
                </div>
