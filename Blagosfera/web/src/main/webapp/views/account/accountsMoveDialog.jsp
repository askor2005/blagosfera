...
<div class="modal fade" id="accounts-move-modal" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false">
		...
		<div class="modal-content">
			<div class="modal-header">
      		...
      		<div class="modal-body">
      			<input type="hidden" id="to-sharer-id" value="" />
      			<div class="form-group">
      				<label>Получатель</label>
      				<input type="text" readonly="readonly" id="to-sharer-full-name" class="form-control">
      			</div>      		
      			<div class="form-group">
				...
				<div class="form-group">
      				...
      				<input type="text" class="form-control" id="amount" placeholder="Сумма для перевода" name="amount" required="required" value="0.00" />
      			</div>
      			<div class="form-group">
