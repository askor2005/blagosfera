...
<script type="text/javascript" language="javascript">
    $(document).ready(function() {
        Ext.onReady(function () {
            storeSubcontractors = Ext.create('Ext.data.Store', {
                id		: 'subcontractorsStore',
                ...
                proxy: {
                    type: 'ajax',
                    url: '/cyberbrain/taskManagement/get_my_subcontractors.json',
                    actionMethods: {
                        read: 'POST'
                    },
                    reader: {
            ...
            Ext.create('Ext.grid.Panel', {
                title: 'Мои субподрядчики',
                store: storeSubcontractors,
                columns: [{
                    text     : 'Кто',
                ...
                listeners: {
                    itemdblclick: function(dataview, record, item, index, e) {
                        record.data.is_customer = 1;
                        showTaskModalWindow(record.data);
                    }
                },
                renderTo: 'subcontractors-grid'
            });
        });
    });
</script>

<div id="subcontractors-grid"></div>