...
<script type="text/javascript" language="javascript">
    ...
    function initBatchVotingsGrid(seoLink, filterParameters) {
        Ext.onReady(function () {
            batchVotingsStore = Ext.create('Ext.data.Store', {
                ...
                proxy: {
                    type: 'ajax',
                    url: '/group/' + seoLink + '/batch_votings_page_grid_data.json',
                    actionMethods: {
                        read: 'POST'
                    },
                    reader: {
                ...
                listeners: {
                    beforeload: function (store, options) {
                        ...
                        store.proxy.extraParams.showMyBatchVotings = filterParameters.showMyBatchVotings;
                    },
