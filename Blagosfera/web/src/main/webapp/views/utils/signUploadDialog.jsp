...
<div class="modal fade" id="sign-upload-dialog" tabindex="-1" role="dialog" aria-hidden="true" data-keyboard="false">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					<button id="show-upload-from-computer-dialog-button" type="button" class="btn btn-primary" style="display: block; width: 100%;">Выбрать файл</button>
				</div>
				<div class="form-group">
