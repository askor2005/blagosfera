...
(function ($) {
        ...
        getSourceNodes: function (nodeId, force) {
            ...
            var defaultSourceOptions = {
                ...
                error: function (XMLHttpRequest) {
                	bootbox.alert("Ошибка загрузки разделов");
                },
                complete: function () {
                    if (nodeId > 0) {
    ...
    GTreeTableNode.prototype = {
        ...
        _move: function(oDestination, position) {
            ...
            if (oOldNodeParent && oOldNodeParent.getDescendants({depth: 1, includeNotSaved: true}).length === 0) {
    ...
    $.fn.gtreetable.defaults = {
        ...
        defaultActions: [
            ...
            },
            {
                name: '${delete}',
                event: function (oNode, oManager) {
                	bootbox.confirm(oManager.language.messages.onDelete, function(result) {
                		oNode.remove();
                	});
                }
            }
