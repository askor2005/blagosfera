 ...
 * Редактор слушателей жизненного цикла процесса
 */
define([
    ...
    "backbone",
    "jquery",
    "text!./template/ExecutionListenersModal.html"
    ...
    var ModalEditor = Backbone.View.extend({
        ...
        addEvent: function () {
            ...
            collection.add({id: collection.length + 1, event: "start", value: "", type: "className", attributes: []});
        },
