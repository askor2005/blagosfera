/**
 * Created by aotts on 22.10.2015.
...
define([
    ...
    "backbone",
    "jquery",
    "text!./template/SignalDefinitionsModal.html"
    ...
    var childTemplate = _.template('' +
        ...
        '           <option value="processInstance">В пределах процесса</option>' +
        '       </select>' +
        '   </td>' +
        '   <td>' +
    ...
    var SignalCollection = Backbone.Collection.extend({
    ...
    var ModalEditor = Backbone.View.extend({
        ...
        initialize: function () {
            this.eventsList = new ListView({
                ...
                childBindings: "name",
                collectionClass: SignalCollection
            });
            this.bindTableRows();
