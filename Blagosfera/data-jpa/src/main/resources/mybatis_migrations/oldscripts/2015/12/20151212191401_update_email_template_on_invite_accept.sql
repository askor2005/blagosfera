                    ...
                    <table border="0" cellspacing="0" cellpadding="0" width="99%">
                        ...
                        <tr>
                            ...
                            <td width="100%">
                                ...
                                <p style="font-family:Arial; font-size:13px; padding: 5px 10px; margin: 5px 0; color: #333333; text-align: center;"><a href="${applicationUrl}/${inviteAccept}" style="text-decoration: initial; color: #3366FF; font-size: 18px;">Вход в Систему БЛАГОСФЕРА</a></p>
                            </td>
                            <td width="20"><div style="height: 8px; overflow: hidden; width: 20px;"></div></td>
                        </tr>
                    </table>
