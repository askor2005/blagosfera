-- // fill descriptions registration
...
begin
  ...
  select id into regionFieldId from fields where internal_name = 'REGION_RL' and fields_group_id = groupId;
  select id into areaFieldId from fields where internal_name = 'AREA_AL' and fields_group_id = groupId;
  select id into cityFieldId from fields where internal_name = 'CITY_TL' and fields_group_id = groupId;
  select id into streetFieldId from fields where internal_name = 'STREET' and fields_group_id = groupId;
  select id into houseFieldId from fields where internal_name = 'HOUSE' and fields_group_id = groupId;
  select id into roomFieldId from fields where internal_name = 'ROOM' and fields_group_id = groupId;

  select id into regionDescriptionFieldId from fields where internal_name = 'REGION_RL_DESCRIPTION' and fields_group_id = groupId;
  select id into areaDescriptionFieldId from fields where internal_name = 'AREA_AL_DESCRIPTION' and fields_group_id = groupId;
  select id into cityDescriptionFieldId from fields where internal_name = 'CITY_TL_DESCRIPTION' and fields_group_id = groupId;
  select id into streetDescriptionFieldId from fields where internal_name = 'STREET_DESCRIPTION' and fields_group_id = groupId;
  select id into houseDescriptionFieldId from fields where internal_name = 'HOUSE_DESCRIPTION' and fields_group_id = groupId;
  select id into roomDescriptionFieldId from fields where internal_name = 'ROOM_DESCRIPTION' and fields_group_id = groupId;
  ...
  FOR sharer IN select * from sharers where deleted=false
  LOOP
