...
begin
  ...
  select id into regionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_REGION' and fields_group_id = groupId;
  select id into areaFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_AREA' and fields_group_id = groupId;
  select id into cityFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_LOCALITY' and fields_group_id = groupId;
  select id into streetFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_STREET' and fields_group_id = groupId;
  select id into houseFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_HOUSE' and fields_group_id = groupId;
  select id into roomFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_OFFICE' and fields_group_id = groupId;

  select id into regionDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_REGION_DESCRIPTION' and fields_group_id = groupId;
  select id into areaDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_AREA_DESCRIPTION' and fields_group_id = groupId;
  select id into cityDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_LOCALITY_DESCRIPTION' and fields_group_id = groupId;
  select id into streetDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_STREET_DESCRIPTION' and fields_group_id = groupId;
  select id into houseDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_HOUSE_DESCRIPTION' and fields_group_id = groupId;
  select id into roomDescriptionFieldId from fields where internal_name = 'COMMUNITY_LEGAL_F_OFFICE_DESCRIPTION' and fields_group_id = groupId;
