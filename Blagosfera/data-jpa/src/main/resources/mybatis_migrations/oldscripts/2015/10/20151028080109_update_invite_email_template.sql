                        ...
                        <div style="border-left: 1px solid #e7e7e7;; border-right: 1px solid #e7e7e7;; border-bottom: 1px solid #e7e7e7;;">
                            <table border="0" cellspacing="0" cellpadding="0" width="99%">
                                ...
                                <tr>
                                    <td width="20"><div style="height: 8px; overflow: hidden; width: 20px;"></div></td>
                                    <td width="100%">
                                        <h3 style="font-family:Arial; color: #616266; text-decoration: none; margin:0;">Здравствуйте, ${inviteUser}!<br>${sharer.fullName} приглашает Вас в Систему БЛАГОСФЕРА</h3>
                                        <hr/>
                                        <p style="font-family:Arial; font-size:13px; padding: 5px 10px; margin: 5px 0; color: #333333;"><a href="${applicationUrl}/${inviteAccept}">Принять приглашение</a></p>
                                        <hr/>
                                        <p style="font-family:Arial; font-size:13px; padding: 5px 10px; margin: 5px 0; color: #333333;"><a href="${applicationUrl}/${inviteReject}">Отклонить приглашение</a></p>
                                        <hr/>
                                        ...
                                        <hr/>
                                        <p style="font-family:Arial; font-size:13px; padding: 5px 10px; margin: 5px 0; color: #333333;">Приглашение действительно в течении ${inviteDaysExpire} дней</p>
                                    </td>
                                    <td width="20"><div style="height: 8px; overflow: hidden; width: 20px;"></div></td>
                                </tr>
                            </table>
...
</html>' where title='invite.email.on-invite';
