...
begin
  ...
  select id into regionFieldId from fields where internal_name = 'FREGION_RL' and fields_group_id = groupId;
  select id into areaFieldId from fields where internal_name = 'FAREA_AL' and fields_group_id = groupId;
  select id into cityFieldId from fields where internal_name = 'FCITY_TL' and fields_group_id = groupId;
  select id into streetFieldId from fields where internal_name = 'FSTREET' and fields_group_id = groupId;
  select id into houseFieldId from fields where internal_name = 'FHOUSE' and fields_group_id = groupId;
  select id into roomFieldId from fields where internal_name = 'FROOM' and fields_group_id = groupId;

  select id into regionDescriptionFieldId from fields where internal_name = 'FREGION_RL_DESCRIPTION' and fields_group_id = groupId;
  select id into areaDescriptionFieldId from fields where internal_name = 'FAREA_AL_DESCRIPTION' and fields_group_id = groupId;
  select id into cityDescriptionFieldId from fields where internal_name = 'FCITY_TL_DESCRIPTION' and fields_group_id = groupId;
  select id into streetDescriptionFieldId from fields where internal_name = 'FSTREET_DESCRIPTION' and fields_group_id = groupId;
  select id into houseDescriptionFieldId from fields where internal_name = 'FHOUSE_DESCRIPTION' and fields_group_id = groupId;
  select id into roomDescriptionFieldId from fields where internal_name = 'FROOM_DESCRIPTION' and fields_group_id = groupId;
